    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barcode', models.CharField(help_text='Unique scannable barcode. For plate wells, this is auto-generated as PlateBarcode-WellID.', max_length=255, unique=True, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9_-]+$', 'Barcode can only contain alphanumeric characters, underscores, and hyphens.')])),
                ...
                ('box_ID', models.CharField(blank=True, help_text='Identifier for the plate or box where this sample is stored', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('barcode', models.CharField(db_index=True, help_text='Unique scannable barcode. For plate wells, this is auto-generated as PlateBarcode-WellID.', max_length=255, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9_-]+$', 'Barcode can only contain alphanumeric characters, underscores, and hyphens.')])),
                ('date_created', models.DateField(help_text='Date when the sample was created')),
                ('notes', models.TextField(blank=True, help_text='Additional notes about this sample', null=True)),
                ('status', models.CharField(choices=[('AWAITING_RECEIPT', 'Awaiting Receipt'), ('AVAILABLE', 'Available'), ('IN_PROCESS', 'In Process'), ('EXHAUSTED', 'Exhausted'), ('CONTAMINATED', 'Contaminated'), ('ARCHIVED', 'Archived')], default='AWAITING_RECEIPT', help_text='The current status of the sample', max_length=20)),
                ('freezer_ID', models.CharField(blank=True, help_text='Identifier for the freezer where this sample is stored', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box_ID', models.CharField(blank=True, help_text='Identifier for the plate or box where this sample is stored', max_length=100, null=True)),
                ('well_ID', models.CharField(blank=True, help_text='Well position in the container (e.g., A1, B2, etc.)', max_length=50, null=True)),
                ('library_type', models.CharField(choices=[('Nextera', 'Nextera'), ('SMARTer', 'SMARTer'), ('Nanopore', 'Nanopore'), ('QIA_COVID', 'QIA_COVID'), ('TruSeq', 'TruSeq'), ('Other', 'Other')], default='Nextera', help_text='The wet-lab kit or method used (e.g., Nextera, SMARTer)', max_length=100)),
                ('analysis_type', models.CharField(blank=True, choices=[('WGS', 'Whole Genome Sequencing (Short-Read)'), ('WGL', 'Whole Genome Sequencing (Long-Read)'), ('MSS', 'Metagenomic Shotgun Sequencing'), ('MTS', 'Metatranscriptomic Sequencing'), ('CFS', 'Cell-Free DNA Sequencing'), ('Other', 'Other')], help_text='The intended bioinformatics analysis (e.g., WGS, MSS)', max_length=100, null=True)),
                ...
                ('sindex', models.CharField(choices=[('S502', 'S502'), ('S503', 'S503'), ('S505', 'S505'), ('S506', 'S506'), ('S507', 'S507'), ('S508', 'S508'), ('S510', 'S510'), ('S511', 'S511'), ('S513', 'S513'), ('S515', 'S515'), ('S516', 'S516'), ('S517', 'S517'), ('S518', 'S518'), ('S520', 'S520'), ('S521', 'S521'), ('S522', 'S522')], default='', help_text='S-index used for this library', max_length=100)),
        ...
        migrations.AddIndex(
            model_name='sequencelibrary',
            index=models.Index(fields=['analysis_type'], name='sampletrack_analysi_6d5f66_idx'),
        ),
        migrations.AddIndex(
            model_name='sequencelibrary',
